...
int zmk_widget_screen_init(struct zmk_widget_screen *widget, lv_obj_t *parent) {
    ...
    lv_canvas_set_buffer(middle, widget->cbuf2, BUFFER_SIZE, BUFFER_SIZE, LV_COLOR_FORMAT_I1);
    lv_canvas_set_palette(middle, 0, lv_color_to_32(lv_color_hex(0xffffff), LV_OPA_COVER));
    lv_canvas_set_palette(middle, 1, lv_color_to_32(lv_color_hex(0x000000), LV_OPA_COVER));

    lv_obj_t *bottom = lv_canvas_create(widget->obj);
    lv_obj_align(bottom, LV_ALIGN_TOP_RIGHT, BUFFER_OFFSET_BOTTOM, 0);
    lv_canvas_set_buffer(bottom, widget->cbuf3, BUFFER_SIZE, BUFFER_SIZE, LV_COLOR_FORMAT_I1);
    lv_canvas_set_palette(bottom, 0, lv_color_to_32(lv_color_hex(0xffffff), LV_OPA_COVER));
    lv_canvas_set_palette(bottom, 1, lv_color_to_32(lv_color_hex(0x000000), LV_OPA_COVER));
