...
int zmk_widget_screen_init(struct zmk_widget_screen *widget, lv_obj_t *parent) {
    ...
    lv_canvas_set_palette(middle, 0, lv_color_to_32(lv_color_hex(0x000000), LV_OPA_COVER));
    lv_canvas_set_palette(middle, 1, lv_color_to_32(lv_color_hex(0xffffff), LV_OPA_COVER));
    ...
    lv_canvas_set_palette(bottom, 0, lv_color_to_32(lv_color_hex(0x000000), LV_OPA_COVER));
